...
impl Shuttle {
    pub fn new() -> Self {
        ...
        let x = rng.gen_range(50..SCREEN_WIDTH - 50);
        let y = rng.gen_range(10..SCREEN_WIDTH / 8);
    ...
    pub fn is_low_altitude(&self) -> bool {
        self.position.y + self.velocity.y as i32 >= SCREEN_HEIGHT - SCREEN_HEIGHT / 4
    }
